...
Route::group(['prefix'=>'cart'], function(){
    ...
    Route::post('/update/event',[CartController::class, 'updateCartEvent']);
...
Route::get('success/subscribe/payment/{subscription_id}/{user_id}', [SubscriptionController::class, 'successSubscribePayment'])->name('successSubscribePayment');
...
Route::post('/doctor/sessions',[DoctorController::class,'allSessions']);
Route::post('/doctor/sessions/request',[DoctorController::class,'doctorRequest']);

Route::get('/doctors/requests',[DoctorController::class,'allDoctorsRequests']);
Route::post('/doctor/request/update',[DoctorController::class,'updateDoctorsRequest']);
Route::get('/doctor/requests',[DoctorController::class,'allDoctorRequests']);
...
Route::post('/cancel/voucher',[OrderController::class,'cancelVoucher']);
